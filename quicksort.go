...
func quicksort(numeros []int) []int {
	...
	// n[:indicePivo] primeiro elemento até o pivô
	// n[indicePivo+1:] elemento posterior até o último elemento disponível
	// ... Todos os elementos do segundo slice devem ser adicionados no slice base
	// Obtendo uma lista com todos os elementos menos o pivô
